    ...
    return (
        <div>
            ...
            <p className='menu-text'>
                ...
                <div>
                    <h1 className='menu-section'>Hors d'oeuvre</h1>
            <div>
        ...
        <div>
            <h1 className='menu-section'>Soupe et Salades</h1>
            <div>
        ...
        <div>
            <h1 className='menu-section'>Sandwiches</h1>
            <div>
        ...
        <div>
            <h1 className='menu-section'>Entrees</h1>
            <div>
        ...
        <div>
            <h1 className='menu-section'>Dessert</h1>
            <div>
